...
module.exports.runValidation = (req, resp, next) => {
  ...
  if (process.env.NODE_ENV_DEV) { console.log(lang.LABEL_ERROR_RETURN, errorValidation); }
  if (!errorValidation.isEmpty()) { return resp.status(422).json(lang.LABEL_422_HTTP); }
  next();
};
