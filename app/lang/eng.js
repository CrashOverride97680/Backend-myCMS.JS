...
// LABEL WEB_API
  ...
  LABEL_LIMIT_SERVER: 'REQUEST MAX FOR THIS HOUR!',
  LABEL_LIMIT_INFORMATION: 'REQUEST LIMITED FOR:',
  LABEL_LIMIT_ILLIMITATED: 'ILLIMITATED REQUEST ACTIVATED',
  ...
  LABEL_ADMIN_PROBLEM_NOT_CONFIRMED_EMAIL: 'TOKEN OR EMAIL NOT CONFERMATED IN TIME FOR RECREATE ADMIN USER DELETE IN PANEL THIS USER',
  LABEL_INSTALLED_CMS: 'CMS INSTALLED CORRECT!',
  LABEL_INSTALLED_CMS_ERROR: 'CMS ERROR IN INSTALLATION RE-RUN CMS',
  LABEL_INSTALLETION_CMS_GEN_ERR: 'CMS GENERAL ERROR IN INSTALLATION:',
  // LABEL CHECK DATA
  ...
  LABEL_DEBUG_INSTALLATION: 'PROBLEM IN INSTALLATION:',
  LABEL_INSTALLATION_COMPLETE: 'INSTALLATION COMPLETE CMS RE-RUN CMS WITHOUT INSTALLATION VARIABLE',
  LABEL_CONTROL_CMS: 'RE-CHECK CMS IN INSTALLETION CMS GENERATE GENERAL ERROR',
  LABEL_USER_EXIST_INSTALLED: 'USER ROOT EXIST IN DB YOUR CMS HAS BEEN INSTALLED',
  LABEL_USER_ADMIN_EXIST: 'USER ALREADY CREATED PREVIOUSLY PLEASE ACCESS AND CHANGE USER DATA',
  ...
  LANG_REGISTERED_USER_SUBJECT: 'Confirm registration',
  // LABEL SCHEDULER
